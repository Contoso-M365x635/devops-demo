...
if (-not (Get-Command terraform -ErrorAction SilentlyContinue)) {
    ...
    $env:PATH += ";$env:LOCALAPPDATA\Microsoft\WinGet\Packages\HashiCorp.Terraform_*\terraform.exe"
}
...
$applyConfirm = Read-Host "Apply this plan and deploy the Windows VM? (yes/no)"
